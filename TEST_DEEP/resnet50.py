...
from cnvrg_src.TensorTrainer import TensorTrainer
...
if __name__ == '__main__':
	...
	num_of_colors = 3 if args.image_color == 'rgb' else 1

	base_model = tf.keras.applications.ResNet50(weights='imagenet',
	                                            include_top=False,
	                                            input_shape=(int(args.image_height), int(args.image_width), num_of_colors))

	trainer = TensorTrainer(base_model, 'resnet50', args)
	trainer.run()