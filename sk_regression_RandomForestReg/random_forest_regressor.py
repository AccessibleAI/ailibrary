...
def _cast_types(args):
    ...
    try: args.min_samples_split = int(args.min_samples_split)
    except ValueError: args.min_samples_split = float(args.min_samples_split)

    try: args.min_samples_leaf = int(args.min_samples_leaf)
    except ValueError: args.min_samples_leaf = float(args.min_samples_leaf)

    args.min_weight_fraction_leaf = float(args.min_weight_fraction_leaf)

    # max_features.
    if args.max_features in ["auto", "sqrt", "log2"]: pass
    elif args.max_features == 'None': args.max_features = None
    else:
        try: args.max_features = float(args.max_features)
        except ValueError: args.max_features = int(args.max_features)
    ...
    args.oob_score = (args.oob_score == 'True')
