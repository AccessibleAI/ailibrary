The library is a wrapper for the ``Tensorflow2`` implementation of the MobileNet module. The library enables you to create a deep neural network based on MobileNet.
