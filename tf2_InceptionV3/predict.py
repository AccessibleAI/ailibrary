...
parser.add_argument('--image_height', action='store', dest='h', required=True, help='image height.')
parser.add_argument('--image_width', action='store', dest='w', required=True, help='image width.')
args = parser.parse_args()

model = load_model('model.h5')

image_path = args.path
img_height, img_width = int(args.h), int(args.w)
