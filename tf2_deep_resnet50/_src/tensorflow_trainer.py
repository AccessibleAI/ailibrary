...
class TensorflowTrainer:
	...
	METRICS = {
		'pre-training': ['TensorFlow version', 'GPUs found', 'Model', 'Classes list'],
		'post-training': ['training_time', 'epochs_duration', 'avg_time_per_epoch', 'time_per_step'],
