The library is a wrapper for the ``Tensorflow2`` implementation of the InceptionV3 module. The library enables you to create a deep neural network based on InceptionV3.
